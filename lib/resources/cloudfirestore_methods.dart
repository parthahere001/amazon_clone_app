  ...
  required String sellerUid,
    ...
    if (image != null && productName!=null && rawCost!= null)
    {
      try{
        ...
        ProductModel product = ProductModel(url: url, productName: productName, cost: cost, discount: discount, uid: uid, sellerName: seller, sellerUid: sellerUid, rating: 5, noOfRating: 0);
...
Future<List<Widget>> getProductsFromDiscount(int discount) async {
   ...
   QuerySnapshot<Map<String,dynamic>> snap =  await firebaseFirestore.collection("products").where("discount", isEqualTo: discount).get();
